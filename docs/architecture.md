...
Backend и plugin-bridge для узкого, управляемого MVP Figma Gateway.

Фокус первой версии:

- React + TypeScript UI
- базовые визуальные блоки и layout
- создание Figma-макета
- обратная синхронизация простых визуальных изменений в код
